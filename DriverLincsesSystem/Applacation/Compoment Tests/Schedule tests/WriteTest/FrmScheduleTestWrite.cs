...
{
    public partial class FrmScheduleTestWrite : Form
    {
        ...
        public FrmScheduleTestWrite(int LocalDrivingLicenseID)
        {
            InitializeComponent();
        ...
        public FrmScheduleTestWrite(int LocalDrivingLicenseID,int TestAppoitmentID)
        {
            InitializeComponent();
        ...
        {
            ctrScheduleTestInfo1.TestTypeID = 2;
        ...
        private void FrmScheduleTestWrite_Load(object sender, EventArgs e)
        {
